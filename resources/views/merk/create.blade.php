...
<div class="row">
        ...
        <div class="card card-primary card-outline mb-4">
                  <!--begin::Header-->
                  <div class="card-header"><div class="card-title">Tambah merk</div></div>
                  <!--end::Header-->
                  <!--begin::Form-->
                <form action="{{ route('merk.store') }}" method="POST">  <!-- untuk pilih foto dari storage / untuk upload file -->
                    @csrf
                    <!-- @method('POST') -->
                  <form>
                    <!--begin::Body-->
                    <div class="card-body">
                      <div class="col-md-6 mb-3">
                        <label for="nama_merk" class="form-label">Tahun Akademik</label>
